...
> **A unique pantry manager that generates creative recipes from your ingredients, prioritizing what's closest to expiry so nothing goes to waste.**
...
- **Persistent pantry management**
    - Add ingredients with optional inputs (amount, unit & expiry), edit easily or delete with one click
...
- **Bulk Import**
    - Optionally choose to paste plain-text ingredients line by line and let the application parse them into structured entries automatically.
- **Responsive Design**
